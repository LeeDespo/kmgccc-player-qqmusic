...
nonisolated struct TrackSidecar: Codable, Sendable {
    ...
    /// Why the file was downloaded: a user request or a prefetch. Absent for
    /// library tracks. Drives which budget owns the file (schema 10).
    let qqMusicDownloadOrigin: String?
    /// When it was downloaded, so "evict the oldest" has a real ordering.
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case qqMusicDownloadOrigin, qqMusicDownloadedAt
    ...
    init(from decoder: Decoder) throws {
        ...
        qqMusicDownloadOrigin = try c.decodeIfPresent(String.self, forKey: .qqMusicDownloadOrigin)
        qqMusicDownloadedAt = try c.decodeIfPresent(Date.self, forKey: .qqMusicDownloadedAt)
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try c.encodeIfPresent(qqMusicDownloadOrigin, forKey: .qqMusicDownloadOrigin)
        try c.encodeIfPresent(qqMusicDownloadedAt, forKey: .qqMusicDownloadedAt)
